...
[ExecuteInEditMode]
    public class blurComputeScript : MonoBehaviour
    {
    ...
    void Start()
    {
        ...
        handleTintMain = shader.FindKernel("GaussianBlur");
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        // Copy the results
        Debug.Log(tempDestination.width);
        Debug.Log(tempDestination.height);
